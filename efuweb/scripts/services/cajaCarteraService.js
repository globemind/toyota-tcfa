function CajaCarteraService($http, $location, $cookies) {

    var cajaCarteraResponse = {};

    var config = {
        headers: { 'Authorization': $cookies.getObject('token') }
    };

    cajaCarteraResponse.getArchivoProcesado = function(file) {
        return $http.get(apiUrl + 'api/CajaCartera/ProcesadoCartera/' + file, config);
    };
    /*
