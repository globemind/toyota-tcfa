function AllianzCommissionService($http, $location, $cookies) {

    var allianzCommissionResponse = {};

    var config = {
        headers: { 'Authorization': $cookies.getObject('token') }
    };

    allianzCommissionResponse.getArchivoProcesado = function(file) {
    ...
    */
    ...
    return allianzCommissionResponse;
}