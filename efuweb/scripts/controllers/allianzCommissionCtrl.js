angular.module('mainapp').factory('AllianzCommissionService', AllianzCommissionService);

function AllianzCommissionCtrl($scope, $window, $cookies, $location, $stateParams, $state, AllianzCommissionService, Upload) {
...
angular.module('mainapp').controller('allianzCommissionCtrl', AllianzCommissionCtrl);